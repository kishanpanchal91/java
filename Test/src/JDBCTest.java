...
public class JDBCTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			map.put(new SimpleDateFormat("dd-MM-yyyy").parse("19-02-2018"), "7.20");
			String []arr = dataSortByDateDesc(map);
	...
	public static String[] dataSortByDateDesc(Map map) {
		  SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("dd/MM/yyyy", Locale.getDefault());
		  String[] returnArray = new String[]{null,"0"};
		 ...
		 //Map<Date, String> map1 = new TreeMap<Date, String>(new Comparator<Date>() {
		  Map<Date, String> map1 = new TreeMap<Date, String>(new Comparator<Date>() {
		      ...
		      map1.putAll(map);
		   for(Map.Entry<Date, String> e :map1.entrySet()){
		   returnArray[0] = e.getValue();
		   returnArray[1] = DATE_FORMAT.format(e.getKey());
		   break;
